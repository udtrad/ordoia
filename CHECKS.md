...
than trusting them. `DEPLOY.md` carries the runbook and the post-deploy `curl`
assertions that close the gap between what the build emits and what a host returns.
